    ...
    <>
      <div className="pb-10" id="Industries">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center mb-5 sm:mb-10 mt-10">
          ...
          <h2 className="text-[25px] min-[303px]:text-[28px] min-[352px]:text-[30px] sm:text-[36px] md:text-[42px] font-bold text-gray-900 leading-tight">
            CRM Built for
      ...
      <div className="max-w-7xl mx-5 md:mx-11 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 py-5">
        {[
          {
            title: "Textile CRM",
            icon: "🧵",
